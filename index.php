            ...
            <div class="hero-container">
                <div class="wow fadeIn">
                    <div class="hero-logo">
                        ...
                        <!--<h1>Simplificando processos, desenvolvendo soluções</h1>-->
                    </div>

                    <!--<h1>Welcome to Code digital</h1>-->
                    <h2>Nós criamos <span class="rotating"> soluções digitais, websites funcionais, estruturas integradas, projetos especiais</span></h2>
                    <div class="actions">
        ...
        <header id="header">
            <div class="container">
                ...
                <div id="logo" class="pull-left">
                    <a href="#hero"><img src="img/logo/logo-2.png" alt="" title="" /></a>
                </div>
            ...
            <div class="container about-container wow fadeInUp">
                <div class="row">
                    <div class="col-md-6 col-md-push-6 about-content">
                        <h2 class="about-title">Nós oferecemos um ótimo serviço e grandes idéias </h2>
                        <p class="about-text">
                            Fundada por dois amigos programadores, cujo objetivo é oferecer aos seus clientes diversos tipos de soluções tecnológicas, com foco na otimização dos processos de todo ciclo de seu negócio.
                            Para que você se preocupe apenas em fazer a gestão do seu negocio sem se preocupar com a estrutura tecnológica.
                        </p>
                        <p class="about-text">
                            A Code Digital é uma agência que venho para solucionar sua comunicação com seu cliente e gerar retornos para o seu negócio. Atendendo suas necessidades, trabalhando com a ética, precisão e inovação. Aprimorando continuamente nossos serviços, prosperando como uma empresa e proporcionando ótimos resultados.
                        </p>
                        <p class="about-text">
                            A Code Digital é uma agência que venho para solucionar sua comunicação com seu cliente e gerar retornos para o seu negócio.
                        </p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignLeft">
                                        <div class="cbp-l-caption-body">
                                            <div class="cbp-l-caption-title">Fabio Medeiros</div>
                                        </div>
                                    </div>
                                </div>
                            </a> 
                    ...
                    <div class="col-md-8 col-md-push-2">
                        <div class="form">
                            ...
                            <form action="" method="post" role="form" class="contactForm">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Celular" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Envie sua menssagem para nós" placeholder="Mensagem"></textarea>
                                    <div class="validation"></div>
                                </div>
        ...
        <footer id="footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            &copy; Copyright <strong>Code Digital</strong>. All Rights Reserved
                        </div>
                    </div>
                </div>
            </div>
